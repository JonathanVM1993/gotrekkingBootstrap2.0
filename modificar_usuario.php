...
<div class="row" style="margin-top:150px;">
	...
	<div class="col-12 col-xl-8 col-xs-12 contenedortrp  ">

<div class="container">
	<div class="row">

<div class="col-12 col-xl-7 col-xs-12 ">
	...
	<table class='table-responsive'>
	 <tr>
		 <td><p>Correo:</p></td>
		 <td><input type='text' id='txtCorreo' name='txtCorreo' disabled placeholder='$getCorreo' onkeypress='return soloEmail(event)' onpaste='return false'></td>
	 </tr>
	 <tr>
		 <td><p>Nombres:</p></td>
		 <td><input type='text' id='txtNombres' name='txtNombres'  placeholder='$getNombres' onkeypress='return sololetras(event)' onpaste='return false'></td>
	 </tr>
	 <tr>
		 <td><p>Apellidos:</p></td>
		 <td><input type='text' id='txtApellidos' name='txtApellidos'  placeholder='$getApellidos' onkeypress='return soloRut(event)' onpaste='return false'></td>
	 </tr>
	 <tr>
		 <td><p>Rut:</p></td>
		 <td><input type='text' id='txtRut' name='txtRut'  placeholder='$getRut' onkeypress='return soloRut(event)' onpaste='return false'></td>
	 </tr>
	 <tr>
...
<div class="col-12 col-xl-5 d-xs-none">

	<div class="col-12 col-xl-4 col-xs-12 " style="margin-top:50px;">
