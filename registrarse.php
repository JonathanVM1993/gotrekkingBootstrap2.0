...
<body>
	...
	<ul class="navbar-nav fondonegro justify-content-center mr-auto mt-2 mt-md-0 mgtop " style="padding:40px" >
		...
		<li class="nav-item"><a href="noticias.php" class="nav-link bg-warning" style="color:#0f0f0f;">Noticias</a></li>
	...
	<div class="col-12 contentainer-fluid ">
		...
		<div class="col-12 col-xl-4 d-xs-none"></div>
			<div class="col-12 col-xl-4 col-xs-12" style="margin-top:50px;">
				<div class="container">
					<div class="row">
						<div class="col-12 col-xl-12 col-xs-12" style="margin-top:50px;">
							<div class="formulario1 contenedortrp" id="formulario">
								<h1>Registrate</h1>
								<ul>
									<form name="formulario-envia" id="formulario-envia" enctype="multipart/form-data" method="post">
										<table class="table-responsive">
											...
											<tr>
												...
												<td><input class="sinborde" name="txtContraseña"  type="password" id="txtContraseña" onkeypress="return soloPassword(event)" onpaste="return false"></td>
											</tr>
											<tr>
