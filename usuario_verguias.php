...
<body>
	...
	<ul class="navbar-nav fondonegro justify-content-center mr-auto mt-2 mt-md-0 mgtop " style="padding:40px" >
		...
		<li class="nav-item"><a href="usuario_verguias.php" class="nav-link bg-warning" style="color:#0f0f0f;">Conoce los guías</a></li>
	</ul>
		</div>
	</div>
	</nav>
              ...
              <?php
                ...
                while ($row=mysqli_fetch_row($ejecutar)) {
								...
								$numero = $numero+1;
									...
									<div class='card' style='height:0px; width:0px; border:0px; margin-top:30px;'>
									<a href='#' data-toggle='modal' data-target='#imagen$numero'>
									<img class='rounded-circle' src='$row[4]' width='150px' height='150px'/>
									</a>
									</div>

									<div class='modal fade' id='imagen$numero' tabindex='-1' role='dialog'>
