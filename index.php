...
<body>
	...
	<ul class="navbar-nav fondonegro justify-content-center mr-auto mt-2 mt-md-0 mgtop " style="padding:40px" >
		<li class="nav-item active"><a href="index.php" class="nav-link bg-warning" style="color:#0f0f0f;">Inicio</a></li>
...
<div class="dropdown-menu fondonegro">
	...
	<div class="col-12 contentainer-fluid " >
		<div class="row">
			...
			<div class="col-12 col-xl-6 col-xs-12 contenedortrp " style="margin-top:150px; width:auto; height:auto;">
				<strong><h1 align="">¿Quieres realizar trekking?</h1></strong>
				<p align="justify">Registrate en nuestra página <a style="color:#cf8613;" href="registrarse.php">haciendo click aquí</a>,
					y así comenzar viendo viajes que se adapten a tu gusto en la sección de <a style="color:#cf8613;" href="usuario_viajes.php">ver viajes</a>, puedes
					cotizar precios y los lugares que más te acomoden, además de una galería de imágenes que te puede ayudar
					en tu elección. No esperes más y acompañanos en la travesía de trekking.
				</p>
				<br>
				<strong><h1 align="">¿Deseas ser guía de trekking?</h1></strong>
				<p>Si es así, no esperes más y postula como guía <a style="color:#cf8613;" href="usuario_postulacion.php">aquí</a>,
				escribenos tu experiencia de trekking junto a tu curriculum para conocerte mejor, de esta manera
				evaluamos si eres capaz de ser guía de trekking, además si llegas a quedar en la postulación, podemos
				asignarte los viajes con los que estás más familiarizados. Cabe destacar que puedes obtener ganancias de cada viaje,
				obteniendo el 90% de el total de el viaje.</p>
			</div>
			<div class="col-12 col-xl-5 d-xs-none"></div>
		</div>
	</div>
